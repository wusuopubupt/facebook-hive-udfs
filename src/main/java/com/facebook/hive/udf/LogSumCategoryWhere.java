 ...
 * for example LOG_SUM_WHERE(col_x, thing='blah', col_category) / SUM(col_x).
 * <p>
 ...
 */
public final class LogSumCategoryWhere extends UDAF {

    public static class LogSumCategoryWhereEvaluator implements UDAFEvaluator {
        ...
        public LogSumCategoryWhereEvaluator() {
            super();
            state = new TreeMap<>();
            init();
        }
